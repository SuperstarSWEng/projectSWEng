...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<div id='cssmenu'>
		...
		<div id='panel_user'>
				<input class="form-control" name="txtUsername" type="text" id="txtUsername" placeholder="Username">
				
		</div>
		<div id='panel_pass'>
				<input class="form-control" name="txtPassword" type="password" id="txtPassword" placeholder="Password">
